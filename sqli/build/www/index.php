        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item pl-1">
                    <a class="nav-link" href="logout.php"><i class="fa fa-sign-out fa-fw mr-1"></i>logout</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container">
    <form method="POST" action="/add_email.php" enctype="multipart/form-data">
        <input type="text" name="email" class="form-control" placeholder="Please enter your email" required autofocus>
        <br>
